...
function Projectcard({ProjectName='Enter the project Name',}) {
    return (
        <div className='flex flex-row justify-center'>
            <div className='bg-blue-500 m-2 my-6 rounded-xl cursor-pointer h-full w-3/5'>
            <div className='bg-gray-700 flex flex-row justify-center text-3xl rounded-t-xl p-4 font-semibold'>
                <h1>{ProjectName}</h1>
            </div>
            <div className='flex flex-row justify-center mx-12'>
                <img src={image} alt="Project-Image" className='w-full mx-16 my-8 border-white border-4 rounded-xl ' />
            </div>
            <div className='px-20 text-xl font-semibold'>
                <h1>
