...
function Projectcard({ ProjectName = 'Enter the project Name', description='Enter the Description' , link='https://google.com'}) {
    return (
        <div className='flex flex-row justify-center'>
            <div className='bg-purple-700 m-2 my-6 rounded-xl cursor-pointer h-full w-full sm:w-3/5'>
                ...
                <div className=' flex flex-row justify-center mb-2'>
                    <a href={link} target="__blank" className='bg-gray-700 w-60 rounded-xl m-2 font-semibold text-xl flex flex-row justify-center p-3 hover:bg-gray-900'>
                        Demo
